...
SECRET_KEY = 'django-insecure-zukp-mt9qm9+s&1#1aka1k_omdg_6^j(8ue_^ezl_p8f=6f8dm'
...
STORAGE_GRPC_HOST = os.environ.get("STORAGE_GRPC_HOST", "storage_service")
STORAGE_GRPC_PORT = os.environ.get("STORAGE_GRPC_PORT", "50053")